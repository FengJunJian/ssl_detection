...
if __name__ == '__main__':
    imgPath='E:/fjj/SeaShips_SMD/JPEGImages/MVI_1592_VIS_00462.jpg'#图片
    onnxfilename = 'detection/fasterRCNN.model'  # 模型
    ...
    a=time.time()
    boxes, probs, labels=session.run(None,input_dict)#outputnames:'output/boxes:0', 'output/scores:0', 'output/labels:0'
    b=time.time()
    print('time:',b-a)
    boxes = boxes / scale
